...
define([
	...
	'underscore',
	'backbone',
	'text!templates/landing/main2.html'
	...
	var landingView = Backbone.View.extend({
		...
		render: function(){
			...
			myAppName.console.log('views/landing/main1.js says Hi');
    ...
    BGImageController = (function () {
        var changeBgImageDim = function () {
                ...
                if (!BGMap.active()) $bg_image.fadeIn(1500)
            },
    ...
    BGSlider = (function () {
        var animated = false,
            ...
            showNavigation = function () {
                $bf_prev.stop().animate({
                    left: '10px'
                }, animSpeed);
                $bf_next.stop().animate({
                    right: '10px'
                }, animSpeed)
            },
            ...
            navigate = function (dir) {
                ...
                (dir) ? ++current : --current;
                if (current > total_items - 1) current = 0;
                else if (current < 0) current = total_items - 1;
    ...
    Template = (function () {
        var animSpeed = 700,
            ...
            togglePageMenu = function (dir) {
                (dir) ? $bf_page_menu.stop().animate({
                    left: '0px'
                }, animSpeed) : $bf_page_menu.stop().animate({
                    left: '-300px'
                }, animSpeed)
            },
            reset = function () {
